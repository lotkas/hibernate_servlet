...
import utils.ServletNullResponse;
...
public class UserController extends HttpServlet {
    ...
    private final ServletNullResponse servletNullResponse = new ServletNullResponse();
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {         //buy product
        ...
        if (response == null) {
            servletNullResponse.nullResponse(resp, out);
        } else {
